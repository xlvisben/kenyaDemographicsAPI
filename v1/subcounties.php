...
*
---------------------------------------------------------------
Function: This file is used to handle logic when getting all subcounties in the database
---------------------------------------------------------------
*
*/
...
if ($_SERVER['REQUEST_METHOD'] != 'GET') {
  ...
  try {
    ...
    $getSubcounties = $subcounty->getSubcounties();

    switch ($getSubcounties['response']) {
      case '200':

        $dataArray = array(
          'status_code' => 200,
          'status_message_short' => 'Success',
          'status_message_description' => 'Success in fetching all subcounties',
          'data' => $getSubcounties['data'],
        );
      ...
      default:
        ...
        $dataArray = array(
          ...
          'status_message_description' => $getSubcounties['message'],
          'data' => $getSubcounties['data'],
        );
