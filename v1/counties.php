...
*
---------------------------------------------------------------
Function: This file is used to handle logic when getting all counties in the database
---------------------------------------------------------------
*
*/
...
if ($_SERVER['REQUEST_METHOD'] != 'GET') {
  ...
  try {
    ...
    $getCounties = $county->getCounties();

    switch ($getCounties['response']) {
      case '200':
      ...
      default:
        ...
        $dataArray = array(
          ...
          'status_message_description' => $getCounties['message'],
          'data' => $getCounties['data'],
        );
